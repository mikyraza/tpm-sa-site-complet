...
<div class="bg-tpm-orange text-white w-full">
    <div class="max-w-container-max mx-auto px-4 md:px-8 py-8 flex flex-col md:flex-row items-center justify-between gap-6">
...
<footer class="bg-tpm-navy text-white pt-16 pb-8 border-t border-white/10 w-full">
    <div class="max-w-container-max mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-white/10">
        ...
        <div class="flex flex-col gap-4">
            ...
            <ul class="flex flex-col gap-2.5 text-xs text-gray-300">
                <li><a href="<?php echo esc_url($shop_url); ?>?pole=toles" class="hover:text-tpm-orange transition-colors flex items-center gap-2"><span class="material-symbols-outlined text-[16px] text-tpm-orange">chevron_right</span> Tôles BAC &amp; Ondulées 0.50mm</a></li>
                <li><a href="<?php echo esc_url($shop_url); ?>?pole=accessoires" class="hover:text-tpm-orange transition-colors flex items-center gap-2"><span class="material-symbols-outlined text-[16px] text-tpm-orange">chevron_right</span> Faîtières &amp; Gouttières</a></li>
                <li><a href="<?php echo esc_url($shop_url); ?>?pole=fixations" class="hover:text-tpm-orange transition-colors flex items-center gap-2"><span class="material-symbols-outlined text-[16px] text-tpm-orange">chevron_right</span> Fixations Complètes &amp; Pointes</a></li>
                <li><a href="<?php echo esc_url($shop_url); ?>?pole=emballages" class="hover:text-tpm-orange transition-colors flex items-center gap-2"><span class="material-symbols-outlined text-[16px] text-tpm-orange">chevron_right</span> Sacs PP Blancs 50kg / 100kg</a></li>
                <li><a href="<?php echo esc_url($shop_url); ?>?pole=carreaux" class="hover:text-tpm-orange transition-colors flex items-center gap-2"><span class="material-symbols-outlined text-[16px] text-tpm-orange">chevron_right</span> Carreaux &amp; Outillage BTP</a></li>
            </ul>
        </div>
        ...
        <div class="flex flex-col gap-4">
            ...
            <ul class="flex flex-col gap-2.5 text-xs text-gray-300">
                ...
                <li><a href="<?php echo esc_url( home_url('/chantiers-btp/') ); ?>" class="hover:text-tpm-orange transition-colors flex items-center gap-2"><span class="material-symbols-outlined text-[16px]">local_shipping</span> Retrait Usine Ex-Works</a></li>
                ...
                <li><a href="#" class="hover:text-tpm-orange transition-colors flex items-center gap-2"><span class="material-symbols-outlined text-[16px]">picture_as_pdf</span> PDF Catalogue Général 2026</a></li>
            </ul>
        </div>
    ...
    <!-- 3. BOTTOM LEGAL BAR -->
    <div class="max-w-container-max mx-auto px-4 md:px-8 pt-6 flex flex-col md:flex-row justify-between items-center text-xs text-gray-400 gap-4">
        <div>
